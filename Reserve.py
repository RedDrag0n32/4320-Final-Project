...
#and the random string
    reservation_code = f"{FirstName[0].upper()}{LastName[-1].upper()}{random_str}"
    print(f"Congratulations {FirstName}, your seat row is {Seatrow}, and the seat number is seat number {Seat}, here is your reservation code = {reservation_code}")
